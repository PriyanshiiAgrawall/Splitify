...
import { Card, CardContent, Typography, Box, AvatarGroup, Stack, Grid } from '@mui/material';
                    ...
                    <Grid item md={6} xs={12}>
                        <AvatarGroup max={3} sx={{ width: '100%' }}>
                            {groupMembers.map(member => (
                                <Avatar
                                    key={member}
                                    name={member} // Use member name to generate initials
                                    size="40" // Customize size
                                    round={true} // Circular avatars
                                    color="random" // Random background color
                                    fgColor="#fff" // White font color
                                />
                            ))}
                        </AvatarGroup>
                    </Grid>
